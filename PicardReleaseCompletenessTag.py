PLUGIN_NAME = "PicardReleaseCompletenessTag"
PLUGIN_AUTHOR = "imolb"
PLUGIN_DESCRIPTION = """
Set a user defined tag TXXX:releasecompleteness if an release is complete i.e. 
...
def set_complete_release_tag(track, file_input):
    album = track.album
...
register_file_post_removal_from_track_processor(set_complete_release_tag)
